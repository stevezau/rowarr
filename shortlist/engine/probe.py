...
def run_privacy_probe(
    ...
    *,
    ...
    would leave `label!=Shortlist_probe` on a real user's share forever — and the first real run
    would then capture that contaminated state as the "pre-Shortlist" snapshot, so even uninstall
